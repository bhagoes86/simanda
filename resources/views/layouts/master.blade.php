...
<html lang="en">
    <head>                        
        <title>Boooya - Fixed Navigation</title>            
    ...
    <body>        
                ...
                <div class="app-sidebar app-navigation app-navigation-fixed scroll app-navigation-style-default app-navigation-open-hover dir-left" data-type="close-other">
                    ...
                    <nav>
                        <ul>
                            ...
                            <li><a href="index.html"><span class="nav-icon-hexa">Ds</span> Dashboard</a></li>
                            <li>
                                <a href="#"><span class="nav-icon-hexa">Pg</span> Pages</a>
                                <ul>                                
                            ...
                            <li><a href="layouts-examples.html"><span class="nav-icon-hexa">Al</span> App Layouts</a></li>
                            ...
                            <li>
                                <a href="#"><span class="nav-icon-hexa">Lc</span> Layout Components</a>
                                <ul>
                                    <li>
                            ...
                            <li>
                                <a href="#"><span class="nav-icon-hexa">Ue</span> UI Elements</a>
                                <ul>                                
                                    ...
                                    <li><a href="components-timeline.html"><span class="nav-icon-hexa">To</span> Timeline</a></li>
        ...
        <!-- THIS PAGE SCRIPTS -->
        <script type="text/javascript" src="{{ asset('theme/js/vendor/bootstrap-datetimepicker/bootstrap-datetimepicker.js') }}"></script>
        
        <script type="text/javascript" src="{{ asset('theme/js/vendor/jvectormap/jquery-jvectormap.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('theme/js/vendor/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
        <script type="text/javascript" src="{{ asset('theme/js/vendor/jvectormap/jquery-jvectormap-us-aea-en.js') }}"></script>
        ...
        {{--  <script type="text/javascript" src="{{ asset('theme/js/app_demo.js') }}"></script>  --}}
        <!-- END APP SCRIPTS -->
    </body>
</html>